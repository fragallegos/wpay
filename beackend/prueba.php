...
function request($customParam, $valor){
  $ip;
  if (!empty($_SERVER['HTTP_CLIENT_IP'])) {
    ...
    $data = "entityId=8ac7a4c871bf63f00171c2f2e77c0d14".
            ...
            "&customer.middleName=luna".
            "&customer.surname=daniel".
            "&customer.ip=192.168.1.1".
            "&customer.merchantCustomerId=00000001".
            "&merchantTransactionId=00000001".
            "&customer.email=pepejose@outlook.com".
            "&customer.identificationDocType=IDCARD".
            "&customer.identificationDocId=1718556598".
            "&customer.phone=0992798518".
    ...
    $data.='&cart.items[0].price='.$item[0]['precio'];
